...
export default function TestimonialsPage() {
            ...
            <Quote className="h-12 w-12 text-cyan-600 mb-6" />
              <div className="flex items-center mb-4" >
              {
                ...
                < p className = "text-lg text-gray-700 font-sans mb-6 italic leading-relaxed" >
                  "Philanzel Investment Services transformed my approach to wealth management. Their personalized strategy
  ...
  services.Philanzel changed my perspective completely.Their risk management approach protected my
            ...
            < Card className = "border-0 shadow-lg hover:shadow-xl transition-shadow" >
              <CardContent className="pt-6" >
                <div className="flex items-center mb-4" >
                {
                  ...
                  < p className = "text-gray-600 font-sans mb-4 italic" >
                    "During the 2020 market crash, while others panicked, Philanzel kept me calm and actually found
            ...
            < Card className = "border-0 shadow-lg hover:shadow-xl transition-shadow" >
              <CardContent className="pt-6" >
                <div className="flex items-center mb-4" >
                {
                  ...
                  < p className = "text-gray-600 font-sans mb-4 italic" >
                    "As a busy doctor, I don't have time to manage investments. Philanzel takes care of everything while keeping
  ...
  <footer className="bg-gray-900 text-white py-16" >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8" >
        <div>
        <h3 className="text-2xl font-serif font-black text-cyan-400 mb-4" > Philanzel Investment Services </h3>
